        ...
        <CardContent className="space-y-6 pt-4">
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="account" className="text-zinc-400 text-xs font-bold uppercase tracking-widest pl-1">登录账号</Label>
              <Input
                id="account"
                type="text"
                placeholder="邮箱或用户名"
                ...
                required
                className="bg-zinc-950/50 border-white/10 text-white focus:border-blue-500/50 focus:ring-blue-500/20 h-12 transition-all pl-4"
              />
            </div>
            <div className="space-y-2">
